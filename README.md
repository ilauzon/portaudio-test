...
If this does not work, you need to change the audio device it is trying to play from. The program starts with printing out a list of your available audio devices, change `OUTPUT_DEVICE` in `main.cpp` to the device number of the device you want audio to play from.
